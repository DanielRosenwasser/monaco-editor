...
//#endregion
var typescriptDefaults = new LanguageServiceDefaultsImpl({ allowNonTsExtensions: true, target: ScriptTarget.ES5, module: ModuleKind.CommonJS }, { noSemanticValidation: false, noSyntaxValidation: false });
var javascriptDefaults = new LanguageServiceDefaultsImpl({ allowNonTsExtensions: true, allowJs: true, target: ScriptTarget.ES5, module: ModuleKind.CommonJS }, { noSemanticValidation: true, noSyntaxValidation: false });
